...
// OpenGL and OpenCL sample code provided by Professor Mike Bailey.
// The solution is convigured to run in Visual Studio with Windows SDK installed.
...
const char* WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Evgeny Ovechnikov" };
const char* GLUITITLE = { "User Interface Window" };

// random parameters:
const float XMIN = { 600.0 };
...
Display()
{
    ...
    if (WhichProjection == ORTHO) {
        glOrtho(-300., 300., -300., 300., 0.1, 6000.);
    }
    else {
        gluPerspective(50., 1., 0.1, 6000.);
    }

    glMatrixMode(GL_MODELVIEW);
    glLoadIdentity();
    gluLookAt(800., -100., 4000., 800., -100., 0., 0., 1., 0.);
    ...
    // ****************************************
    // Here is where the current state of the particles is drawn:
    // ****************************************
    ...
    // ****************************************
    // Here is where spheres are drawn.
    // ****************************************
...
InitLists()
{
    ...
    // This had better match the definition of the first sphere in the .cl file
    // ****************************************
    ...
    // This had better match the definition of the second sphere in the .cl file
    // ****************************************
    glColor3f(1.f, 0.f, 0.5f);	// 0. <= r,g,b <= 1.
    glPushMatrix();
    glTranslatef(1700.f, -800.f, 0.f);
    glutWireSphere(600.f, 100, 100);
    glPopMatrix();
